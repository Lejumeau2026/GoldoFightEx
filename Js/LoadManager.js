function LoadManager () {
	this.imageMap = {
      ...
      'BackCentre': './Images/BackCentre.jpg',
      ...
      'BonusAmirale3D': './Images/BonusAmirale3D.png',
      'BonusMortanium': './Images/BonusMortanium.png',
      ...
      'GoldoBrasFulguropoing':'./Images/GoldoBrasFulguropoing.png',
      ...
      'MortaniumMap': './Images/MortaniumMap.png',
      ...
      'GrandeNavetteMap': './Images/GrandeNavetteMap.png',
      ...
      'CyberMineFlash': './Images/CyberMineFlash.png',
      ...
      'SiloIllumine':'./Images/SiloIllumine.png',
	  ...
	  'SoucoupeAmirale3D': './Images/SoucoupeAmirale3D.png',
      'RayonEnergie':'./Images/RayonEnergie.png',
      'RayonEnergyBall':'./Images/RayonEnergyBall.png',
      'EnergieFreezeFireMap':'./Images/EnergieFreezeFireMap.png',
	  
      'LazerAmirale3D':'./Images/LazerAmirale3D.png',
      'MortaniumHeader':'./Images/MortaniumHeader.png',

      'Road07TurnLeft':'./Images/Road07TurnLeft.png',
      'Road07Forward':'./Images/Road07Forward.png',
      'Road07TurnRight':'./Images/Road07TurnRight.png',
      'Road07BordLeft':'./Images/Road07BordLeft.png',
      'Road07BordForward':'./Images/Road07BordForward.png',
      'Road07BordRight':'./Images/Road07BordRight.png',
      'EndRoad07':'./Images/EndRoad07.png',
      'Blocker':'./Images/Blocker.png',
      'BlockerRail':'./Images/BlockerRail.png',
      'BlockerRayon':'./Images/BlockerRayon.png',
	  
      'BarProgress':'./Images/BarProgress.png',
      'BarProgressEnergyDown':'./Images/BarProgressEnergyDown.jpg',
      'BarProgressEnergyUp':'./Images/BarProgressEnergyUp.jpg',
      'TabBord':'./Images/TabBord.png',
	  
      'RampeSupport':'./Images/RampeSupport.png',
      'Rampe':'./Images/Rampe.jpg',
	...
	this.audioMap = {
	  'GoldorakUfo':'./Music/GoldorakUfo.mp3',
	...
	this.soundMap = {
      ...
      'PlanitronBonus':'./Sound/PlanitronBonus.mp3',
      ...
      'UltraCalorie':'./Sound/UltraCalorie.mp3',
      'UltraBonus':'./Sound/UltraBonus.mp3',
      'MineAlarme':'./Sound/MineAlarme.mp3',
	  
      'HydargosVoilaLePrince':'./Sound/HydargosVoilaLePrince.mp3',
      'EnvoieNavette':'./Sound/EnvoieNavette.mp3',
      'LaserBeam':'./Sound/LaserBeam.mp3',
      'EnergyBall':'./Sound/EnergyBall.mp3',
      'PowerDown':'./Sound/PowerDown.mp3',
      'HydargosOnSeRetrouvera':'./Sound/HydargosOnSeRetrouvera.mp3',
      'LazerDirect':'./Sound/LazerDirect.mp3',
      'Mortanium':'./Sound/Mortanium.mp3',
      'GoldorakGoRoad':'./Sound/GoldorakGoRoad.mp3',
      'GoldoPassage01':'./Sound/GoldoPassage01.mp3',
      'RoadAlarme':'./Sound/RoadAlarme.mp3',
      'ToutesLesportesDeLaRoute07':'./Sound/ToutesLesportesDeLaRoute07.mp3',
      'Victorang':'./Sound/Victorang.mp3',
    };
	...
	{
		this.currentAudioNode = this.audioAutoList.AddObject (this.GetAudioByName('GoldorakUfo'));
		this.audioAutoList.AddObject (this.GetAudioByName('Victoire01'));
		this.audioAutoList.AddObject (this.GetAudioByName('Combat06'));
		this.audioAutoList.AddObject (this.GetAudioByName('Combat04'));
		this.audioAutoList.AddObject (this.GetAudioByName('Combat08'));
	...
	{	
		...
		for (var key in this.imageMap) 
		{
			...
			switch (key)
			{
				...
				case 'GrandeNavetteMap':
				for (var i = 1; i <= 6; i++)
				{
					model = this.GetModel ('GrandeNavetteMap'+i);
					if (model != null && model.shadow == true)
					{
						this.CreateShadowImage (model);
					}
	...
	this.NewEntityModel = function (imagename,img)
	{
		...
		switch (imagename)
		{
			...
			case 'MortaniumMap':
			jsonmodel = this.jsonModelArray['Mortanium'];
			imagelist = this.BuildImageList (img,3,3,15,419);
			break;
			...
			case 'GrandeNavetteMap':
			jsonmodel = this.jsonModelArray['GrandeNavette'];
			imagelist = this.BuildImageList (img,6,6,212,158);
			break;
			...
			case 'EnergieFreezeFireMap':
			imagelist = this.BuildImageList (img,3,3,196,153);
			break;
			
			case 'Road07TurnLeft':
			case 'Road07Forward':
			case 'Road07TurnRight':
			case 'EndRoad07':
			jsonmodel = this.jsonModelArray['RoadPassItem'];
			break;

			case 'Road07BordLeft':
			case 'Road07BordForward':
			case 'Road07BordRight':
			jsonmodel = this.jsonModelArray['RoadBlockItem'];
			break;
